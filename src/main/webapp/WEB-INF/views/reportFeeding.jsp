...
<div class="container">
    ...
    <div class="card">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="/reports/feeding">Feeding</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/reports/nap">Nap</a>
            </li>
            <li class="nav-item">
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Number of Feedings' + '-${babyName}',
                backgroundColor: 'rgb(255, 99, 132)',
                borderColor: 'rgb(255, 99, 132)',
                // data: [0, 10, 5, 2, 20, 30, 45]
                data:
                    [
                        <c:forEach items="${numberOfFeedingsLastWeekByBaby}" var="element">
                        ${element.intValue()},
                        </c:forEach>
                    ]
            }]
